...
/**
 * 执行Vue构造函数的初始化
 * 初始化生命周期、事件、渲染、执行beforeCreate、初始化props、methods、data、computed、provide、执行created
 */
...
export function initMixin (Vue: Class<Component>) {
  Vue.prototype._init = function (options?: Object) {
    ...
    let startTag, endTag
    /* istanbul ignore if */
    if (process.env.NODE_ENV !== 'production' && config.performance && mark) {    // 性能优化埋点
    ...
    if (vm.$options.el) {      // 如果有el直接挂载在el上
